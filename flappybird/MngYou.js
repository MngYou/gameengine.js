/*
	新增(相对于跑酷时)
		...
		group.setAll
		修复滚屏特效数值类型不统一
		滚屏bug:新加滚屏会与旧滚屏混用使得速度更快 解决方案 取旧id关闭定时器 未修复
		引入了Poetry's Blog中的缓动动画时间版 -- 0.153 量起始为0 可以改为目标对象的当前值
		新增图形对象(DOM_Image对象) -- 0.154
		修复tilesprite 原this.x\y\width\height的bug
*/
var MngYou = {};
...
MngYou.Game.prototype.add = function(){
	...
	this.add.gif = function(x,y,imageSrc,state){
		return MngYou.Img(x,y,imageSrc,state);
	}
...
*/
MngYou.Img = function(x,y,src,state){
...
/*
	...
	state: 父级场景
*/
MngYou.Image = function(x,y,width,height,imageSrc,state){
	var obj = document.createElement('div');
	obj._type = 'image';
	obj.originalSize = [width,height];
	obj.id = obj._type;
...
/*
	setAngle: 设置旋转角度
*/
Object.prototype.setAngle = function(value){
...
/*
	...
	style: 重力数组
*/
Object.prototype.gravity = function(style,gameStart){
	if (gameStart==false) {
		return false;
	}
...
/*
	...
	move(box,{"width":200,"height":200,"left":100,"top":100,"opacity":100},1500,function(){}
	game.tween.to(hand,{'x':-30},10000,'linear');
*/ 		//mc ==> motion curve
