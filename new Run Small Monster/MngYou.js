...
Object.prototype.velocity = function(style){
	...
	this.velocityY = style.velocityY || 30;
	...
	Object.defineProperty(o, p, {
		get: function ()
		{
	    	...
	    	if (p=='tilePositionX') {//tileSprite.tilePosition.x
	    		return this.style.backgroundPosition.split(" ")[0].split("px")[0];
	    	}
	    	if (p=='tilePositionY') {
	    		return this.style.backgroundPosition.split(" ")[1].split("px")[0];
	    	}
	    	if (p=='width') {
	    		return this.offsetWidth;
	    	}
